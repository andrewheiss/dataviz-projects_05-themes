...
format:
  ...
  typst:
    toc: true
    toc-title: Contents
    output-file: PREFIX_05-exercise.pdf
    pdf-standard: ua-1
...
#| label: base-plot
#| fig-alt: |
#|   Faceted horizontal bar chart of cheese counts by country and milk type,
#|   with default styling. Countries on the y-axis, total cheese count on the
#|   x-axis, and three panels for Cow, Goat, and Sheep milk. Cow milk shows
#|   the highest cheese variety across most countries; sheep milk is 
#|   surprisingly common in Italy; goat milk is common in France.
...
#| fig-alt: |
#|   Faceted horizontal bar chart of cheese counts by country and milk type,
#|   styled with theme_bw and descriptive labels. Countries on the y-axis,
#|   total types of cheeses on the x-axis, three panels for Cow, Goat, and
#|   Sheep milk. Bold facet labels, a left-aligned axis title, and a subtitle
#|   in gray give the chart a polished, professional appearance. The title
#|   reads "Cow-based cheese rules the world."
...
#| fig-height: 3
#| fig-alt: |
#|   Faceted horizontal bar chart of cheese counts, intentionally styled to
#|   be visually unpleasant. Countries on the y-axis, cheese count on the
#|   x-axis, three panels for Cow, Goat, and Sheep milk. The chart uses a
#|   bright green panel background, purple plot background, yellow angled
#|   title text, and upside-down rotated facet labels—demonstrating
#|   principles of bad data visualization design.
